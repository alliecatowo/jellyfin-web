...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.ArrInstance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.MediaRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.RequestStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.SeasonRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.MediaRequest", b =>
                {
                    b.HasOne("Jellyfin.Database.Implementations.Entities.User", "RequestedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.RequestStatus", b =>
                {
                    b.HasOne("Jellyfin.Database.Implementations.Entities.MediaRequest", "MediaRequest")
